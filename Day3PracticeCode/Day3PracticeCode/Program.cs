...
//same as Type teo but with more than one parameter
...
//Type Three
//a function that is takibng some parameters
...
string somerandomsentence2 = $"The random number is {randomnumber2} between {lowerboundvalue} and {upperboundvalue}";
